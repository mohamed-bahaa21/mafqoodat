...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void showPostNotification(String pId, String pTitle, String pDescription ){
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_default);
    ...
    private void updateToken(String tokenRefreash) {
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Tokens");
        Token token = new Token(tokenRefreash);
